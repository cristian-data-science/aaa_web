      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-20">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">
            Nuestros <span className="text-neon-cyan text-shadow-cyan">Servicios</span>
          </h2>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              ">
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center text-sm text-gray-500 group-hover:text-gray-400 transition-colors">
                      <span className="w-1.5 h-1.5 bg-neon-cyan rounded-full mr-2 flex-shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
                ...
                {!prefersReducedMotion && (
                  <motion.div
                    className="absolute -inset-1 bg-gradient-to-r from-neon-cyan via-neon-purple to-neon-green rounded-2xl opacity-0 group-hover:opacity-20 blur-xl -z-10"
                    initial={false}
                  />
                )}
              </div>
