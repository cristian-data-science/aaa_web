...
const Hero = () => {
  ...
  // Partículas flotantes sutiles (solo desktop); el color sale de --glow
  // para que cambien de tono con el tema activo
    ...
    <section ref={sectionRef} id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-transparent">
      ...
      {!isMobile && floatingParticles.map((particle) => (
        ...
        >
          <div
            ...
            style={{
              background: 'var(--glow)',
              boxShadow: `0 0 ${particle.size * 4}px var(--glow)`,
            }}
          />
        </motion.div>
      ))}
      ...
      <motion.div style={parallaxStyle} className="container mx-auto px-4 relative z-10 pt-28 pb-10">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-edge bg-surface-2 px-4 py-1.5 text-sm font-medium text-accent-ink backdrop-blur-sm shadow-sm">
          ...
          <div className="mb-10">
            <RevealText
              ...
              delay={0.15}
              stagger={0.08}
              className="font-display font-bold tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-content-1 leading-tight"
            />

            <motion.div
              className="font-display font-bold tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-content-1 mt-6 mb-8"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          {/* Subtitle */}
          <motion.p
            className="text-xl md:text-2xl text-content-2 mb-12 leading-relaxed max-w-3xl mx-auto text-center font-medium"
          ...
          >
            <motion.button
              ...
              className="rounded-full border border-edge bg-surface-2 p-2 text-accent-ink backdrop-blur-sm hover:bg-chip transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600"
              animate={{ y: [0, 8, 0] }}
      ...
      >
        <p className="eyebrow text-center mb-4">
          <ScrambleText text="Nuestro stack tecnológico" />
        </p>
